...
fun InsertMenuScreen(navController: NavController) {
    // เพิ่มเมนูเพื่อเก็บข้อมูลประเภทอาหารทั้งหมด
...
//        selectedFoodType = DropdownMenuTypeItem()
...
//@Composable
//fun DropdownMenuTypeItem(): String {
//    val keyboardController = LocalSoftwareKeyboardController.current
//    var expanded by remember { mutableStateOf(false) }
//    var selectedMenuType by remember { mutableStateOf("") }
//    val menuType = remember { mutableStateListOf<MenuTypeClass>()}
//
...
//        )
//        {
//            selectedMenuType.forEach { selectionOption ->
//                DropdownMenuItem(
//                    text={Text(selectionOption.toString())},
//                    onClick = {
//                        selectedMenuType = selectionOption.toString()
//                        expanded = false
//                    },
